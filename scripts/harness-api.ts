...
function migrationSql(): string {
  ...
  // Schéma métier = init + lot 2 (actions programmées) + lot 3 (rangement des modèles).
  return ['_init_crm_schema', '_lot2_planned_actions', '_lot3_template_layout'].map(suffix => {
