        ...
        <div className="card p-5">
          ...
          <ResponsiveContainer width="100%" height={240}>
            <BarChart data={analytics.bySource.slice(0, 10)} layout="vertical" barSize={16}>
              <XAxis type="number" tick={{ fontSize: 12 }} /><YAxis dataKey="name" type="category" width={compact ? GUTTER_COMPACT : GUTTER_WIDE} tick={{ fontSize: compact ? 10 : 11 }} tickFormatter={compact ? (v: string) => shortLabel(v) : undefined} /><Tooltip />
